...
import AnimationLottie from "../assets/img/login.json";
                  ...
                  <div className="flex flex-col w-max mx-auto text-center">
                    <label>
                      <input
                        ...
                        hidden
                      />
                      <div className="bg-rose-500 overflow-x-hidden max-w-xs text-white border border-gray-300 rounded font-semibold cursor-pointer p-1 px-3 hover:bg-rose-500">
                        {uploadButtonText}
                      </div>
                    </label>
                  </div>
